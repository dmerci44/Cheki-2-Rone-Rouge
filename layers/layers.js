...
lyr_GoogleSatellite_0.setVisible(true);lyr_LIN_1.setVisible(true);lyr_SYST_2.setVisible(true);lyr_numerodordre_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_LIN_1,lyr_SYST_2,lyr_numerodordre_3];
...
lyr_numerodordre_3.on('precompose', function(evt) {
